<template>
  <section :class="sectionClass" id="experience">
    <div class="my-auto">
      <h4 style="font-family: 'Saira Extra Condensed';">Experience</h4>
          ...
          <div class="d-flex flex-column justify-content-between">
            <div class="d-flex flex-row">
              ...
              <div :class="textRightClass">
                <h6 style="font-family: 'Saira Extra Condensed';" class="pdf-experience-dates text-primary">{{ job.startDate }} - {{ job.endDate }}</h6>
              </div>
            </div>
            <div class="d-flex flex-column">
              <h6 style="font-family: 'Saira Extra Condensed';" class="pdf-company">{{ job.company }}</h6>
              <div
