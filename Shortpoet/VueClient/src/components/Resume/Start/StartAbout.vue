    ...
    <div class="my-auto">
      ...
      <div class="ml-2 d-inline-flex flex-column subheading">
        <div class="d-inline-flex flex-column">
          <span id="resume-flags" class="not-name">{{ flags.replace(/,/g, '') }}</span>
          <a :href="'mailto:' + email">{{ email }}</a>
          <!-- <span class="mx-2" style="color:#343a40">&#8226;</span>  -->
          <span id="resume-address">{{ address }}</span>
          <!-- <span class="ml-1">&#937;</span>  -->
        </div>
        <div class="d-flex flex-column">
          <!-- <span class="mx-2" style="color:#343a40">&#8226;</span>  -->
          <span id="resume-visas" class="not-name">Valid Work Visas: {{ visas }}</span>
        </div>
      </div>
    </div>
  </section>
