...
export const state = {
  ...
  _resume: {
        ...
        "jobs": [
          {
            ...
            "description": "New and Pre-owned Car Sales; Sales made in English, Spanish, Tagalog, French, and Mandarin, Self-directed marketing efforts",
            "startDate": "September 2016",
            "endDate": "February 2017"
          },
          {
            "position": "Product Specialist - Sales",
            "company": "Hollywood Electrics – Electric Cycle Dealership",
            "description": "New and Pre-owned Electric Cycle Sales; Sales made in English, Spanish, Tagalog, French, and Mandarin, Self-directed marketing efforts",
            "startDate": "July 2010",
            "endDate": "August 2016"
          }
        ]
        ...
        "jobs": [
          {
            ...
            "description": "Operating 2 apps at the same time to maximize earnings, while maintaining customer satisfaction and high ratings",
            "startDate": "April 2017",
            "endDate": "April 2019"
          },
          {
            "position": "Grill Chef de Partie",
            "company": "Post Haus Restaurant",
            "description": "St. Moritz, Switzerland. helped owner plan restaurant concept, designed Grill Station, assisted in menu planning and execution, provided back-end informational support for owners during the length of the winter season, offering particular assistance interpreting for members of the multi-cultural staff and management",
    ...
    "skills": [
      ...
      {
        "type": "javascript",
        "details": "Vue, d3, Leafly, Plotly, c3"
      },
      {
        "type": "python",
        "details": "Pandas, Matplotlib, Flask, Selenium, Beautiful Soup, Scipy, Numpy, Sklearn"
      },
      {
        "type": "relationalDb",
      ...
      {
        "type": "miscelaneous",
        "details": "Internet Research, Microsoft Office, Adobe Creative Suite, YogaWorks 200hr Yoga TeacherTraning, Cicerone Beer Server Certification"
      }
    ],
    ...
    "educations": [
      ...
      },
      {
        ...
        "degree": "Private secondary boarding school",
        "focus": "emphasis on academics, the outdoors, camping, horsemanship, and environmental awareness, Year Abroad in France"
      }
    ]
  },
  resumeLoaded: false
